...
import { SEOArticle, getSEOArticle } from '@/lib/seo-articles'
...
function ArticleSection({ 
  ...
  const [expanded, setExpanded] = useState(index < 2) // First 2 sections expanded by default
...
interface SEOArticleDisplayProps {
  categoryId: string
}

export default function SEOArticleDisplay({ categoryId }: SEOArticleDisplayProps) {
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            mainEntityOfPage: {
              '@type': 'WebPage',
              '@id': `https://calcilab.com/nutrition/${categoryId}`,
            },
            author: {
              '@type': 'Organization',
              name: 'CalciLab',
            ...
            articleSection: article.content.sections.map(s => s.heading),
          }),
        }}
      />
